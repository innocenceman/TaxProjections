                ...
                else
                {
                    ...
                    switch (axis)
                    {
                        ...
                        case "y":
                            ...
                            // 2.c: transform.Rotate around the X axis using rotationFactor.
                            transform.Rotate(new Vector3(-1 * rotationFactor_y, 0, 0));
                            break;
                        case "z":
                            float rotationFactor_z = eventData.NormalizedOffset.z * RotationSensitivity;
                            // 2.c: transform.Rotate around the Z axis using rotationFactor.
                            transform.Rotate(new Vector3(0, 0, -1 * rotationFactor_z));
                            break;
                    }
